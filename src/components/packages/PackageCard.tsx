      ...
      <Card className="h-full overflow-hidden hover:shadow-lg transition-shadow duration-300">
        ...
        <CardContent className="p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <Link
              to={`/packages/${pkg.id}`}
              className="flex-1 inline-flex items-center justify-center rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 border border-green-600 text-green-600 hover:bg-green-50 focus:ring-green-500 px-4 py-2 text-base"
            >
              View Details
            </Link>
          </div>
