      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center px-4 md:mt-[80px] mt-0">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-2xl md:text-7xl font-bold text-white mb-3 md:mb-4 leading-tight font-heading"
            style={{
          ...
          <motion.p
            ...
            className="text-sm md:text-2xl text-gray-100 mb-4 md:mb-8 font-light font-body"
          >
